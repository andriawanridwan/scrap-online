...
<form action="{{$model->exists ? route('srsselesai.update',$model->id) : route('srsselesai.store') }}" method="post">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <select type="text" id="produk_kemasan" name="produk_kemasan" class="form-control select2">
                    ...
                    <option {{$model->exists && $model->produk_kemasan == 'Kemasan Non Produk' ? 'selected' : ''}} >Kemasan Non Produk</option>
                </select>
            </div>
        </div>
        <div class="col-md-6">
